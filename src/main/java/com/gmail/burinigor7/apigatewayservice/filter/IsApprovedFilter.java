...
@Component
public class IsApprovedFilter extends ZuulFilter {
    ...
    public boolean shouldFilter() {
        final String path = "/payout-requests/isApproved";
    ...
    public Object run() throws ZuulException {
        ...
        String prId = context.getRequest().getParameter("prId");
        context.set(FilterConstants.REQUEST_URI_KEY, "/payout-requests/isApproved");
