...
@Component
public class StartChatFilter extends ZuulFilter {
    ...
    public boolean shouldFilter() {
        final String path = "/tech-support/start-chat";
    ...
    public Object run() throws ZuulException {
        ...
        context.set(FilterConstants.REQUEST_URI_KEY, "/tech-support/start-chat");
