...
@Component
public class SendMessageFilter extends ZuulFilter {
    ...
    public boolean shouldFilter() {
        final String path = "/tech-support/send-message";
    ...
    public Object run() throws ZuulException {
        ...
        context.set(FilterConstants.REQUEST_URI_KEY, "/tech-support/send-message/" + chatId);
