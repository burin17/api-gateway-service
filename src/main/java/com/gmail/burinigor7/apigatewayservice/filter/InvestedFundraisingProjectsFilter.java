...
@Component
public class InvestedFundraisingProjectsFilter extends ZuulFilter {
    ...
    public boolean shouldFilter() {
        final String path = "/invested-fundraising-projects";
    ...
    public Object run() throws ZuulException {
        ...
        context.set(FilterConstants.REQUEST_URI_KEY, "/fundraising-projects/invested");
