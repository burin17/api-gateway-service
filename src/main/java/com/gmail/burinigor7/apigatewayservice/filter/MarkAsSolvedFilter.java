...
@Component
public class MarkAsSolvedFilter extends ZuulFilter {
    ...
    public boolean shouldFilter() {
        final String path = "/tech-support/mark-as-solved";
    ...
    public Object run() throws ZuulException {
        ...
        context.set(FilterConstants.REQUEST_URI_KEY, "/tech-support/mark-as-solved/" + chatId);
