...
@Component
public class AllChatsForTechSpecialistFilter extends ZuulFilter {
    ...
    public boolean shouldFilter() {
        final String path = "/tech-support/all-chats";
    ...
    public Object run() throws ZuulException {
        ...
        context.set(FilterConstants.REQUEST_URI_KEY, "/tech-support/all-chats");
        context.setRequestQueryParams(Map.of("techSpecUsername", List.of(getCurrentUsername())));
        return null;
    }
