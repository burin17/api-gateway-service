...
@Component
public class SelfFundraisingProjectsFilter extends ZuulFilter {
    ...
    public boolean shouldFilter() {
        final String path = "/fundraising-projects/selfProfile";
    ...
    public Object run() throws ZuulException {
        ...
        context.set(FilterConstants.REQUEST_URI_KEY, "/fundraising-projects/username");
