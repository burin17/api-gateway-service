...
@Component
public class IsInvestorFilter extends ZuulFilter {
    ...
    public boolean shouldFilter() {
        final String path = "/user/isInvestor";
    ...
    public Object run() throws ZuulException {
        ...
        String fpId = context.getRequest().getParameter("fpId");
        context.set(FilterConstants.REQUEST_URI_KEY, "/user/isInvestor");
