...
@Component
public class CreateFundraisingProjectFilter extends ZuulFilter {
    ...
    public boolean shouldFilter() {
        final String path = "/fundraising-projects/create";
    ...
    public Object run() throws ZuulException {
        ...
        context.set(FilterConstants.REQUEST_URI_KEY, "/fundraising-projects");
